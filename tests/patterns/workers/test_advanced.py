...
def test_micropip_in_worker_cors_failure(page: Page, live_server: str, cross_origin_server: str):
    """
    ...
    wheel_url = f"{cross_origin_server}/_my_local_package/dist/my_local_package-0.1.0-py3-none-any.whl"
