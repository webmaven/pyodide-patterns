...
The most robust solution, as demonstrated by the https://github.com/webmaven/imposition/[Imposition] project, is to isolate these two types of tests into separate test suites that are run independently.
...
[source,ini]
----
include::integration/pytest.ini[]
----

==== `tests/integration/conftest.py`
[source,python]
----
include::integration/conftest.py[]
----
...
The file `tests/patterns/testing/test_async_conflict_demo.py` demonstrates what happens when an async test is run within the main suite alongside Playwright.

[source,python]
----
include::test_async_conflict_demo.py[]
----
