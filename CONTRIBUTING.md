...
We use **AsciiDoc** (`.adoc`) for in-depth technical guides. This allows us to keep our documentation in sync with the code by using the `include::` directive to pull in actual test files or source code.

When contributing a new pattern:

* Add a corresponding `.adoc` file in the pattern's directory.
* Use `include::` for code examples instead of copy-pasting code blocks.
* Link to your new guide from the main `README.md`.
